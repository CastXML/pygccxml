...
class Test(parser_test_case.parser_test_case_t):
    ...
    def test_vector(self):
        ...
        self.assertEqual('vector<int>', v_traits.remove_defaults(v_int))
    ...
    def test_list(self):
        ...
        self.assertEqual('list<int>', l_traits.remove_defaults(l_int))
    ...
    def test_queue(self):
        ...
        self.assertEqual('queue<int>', q_traits.remove_defaults(q_int))
