...
class declarations_t( parser_test_case.parser_test_case_t ):
    ...
    def test_variables(self):
        ...
        self._test_type_composition( initialized.type, declarations.const_t, declarations.long_unsigned_int_t )
    ...
    def test_calldef_free_functions(self):
        ...
        self._test_calldef_args( no_return_1_arg, [ declarations.argument_t( name=no_return_1_arg.arguments[0].name, type=declarations.int_t() )] )
        ...
        self._test_calldef_args( return_default_args
                                 , [ declarations.argument_t( name=return_default_args.arguments[0].name
                                                 , type=declarations.int_t(), default_value='1' )
                                     , declarations.argument_t( name=return_default_args.arguments[1].name
                                                   , type=declarations.bool_t(), default_value='false' ) ] )
    ...
    def test_calldef_member_functions(self):
        ...
        self._test_calldef_args( member_inline_call, [ declarations.argument_t( name='i', type=declarations.int_t() )] )
        ...
        self.failUnless( member_const_call.virtuality == declarations.VIRTUALITY_TYPES.NOT_VIRTUAL
        ...
        self.failUnless( member_virtual_call.virtuality == declarations.VIRTUALITY_TYPES.VIRTUAL
        ...
        self.failUnless( member_pure_virtual_call.virtuality == declarations.VIRTUALITY_TYPES.PURE_VIRTUAL
    ...
    def test_constructors_destructors(self):
        ...
        arg_type = declarations.declarated_t( self.global_ns.class_('some_exception_t') )
...
class gccxml_declarations_t( declarations_t ):
    ...
    def setUp(self):
        if not gccxml_declarations_t.global_ns:
            ...
            gccxml_declarations_t.global_ns = declarations.get_global_namespace( decls )
