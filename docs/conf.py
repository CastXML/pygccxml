# -*- coding: utf-8 -*-
#
# pygccxml documentation build configuration file, created by
# sphinx-quickstart on Sat May 17 17:37:31 2014.
#
...
latex_documents = [
  ('index', 'pygccxml.tex', u'pygccxml Documentation',
...
man_pages = [
    ('index', 'pygccxml', u'pygccxml Documentation',
     [u'Insight Software Consortium'], 1)
]
...
texinfo_documents = [
  ('index', 'pygccxml', u'pygccxml Documentation',
   u'Insight Software Consortium', 'pygccxml', 'One line description of project.',
   'Miscellaneous'),
]
